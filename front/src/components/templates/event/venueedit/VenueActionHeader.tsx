export default function VenueActionHeader() {
  return (
    <div className="flex flex-col justify-center items-center border border-gray-900 mx-2 rounded-lg p-4 m-4 gap-4">
      <div className="items-center justify-between w-full grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-2">
        <div className="col-span-1 lg:col-span-3 xl:col-span-1 flex justify-between mx-2">
